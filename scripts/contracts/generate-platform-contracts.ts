...
const schemas: Record<string, JsonSchemaProvider> = {
  ...
  WorkspaceExecutionMetricsQueryV1: workspaceExecutionMetricsQueryV1Schema,
  WorkspaceExecutionMetricSegmentV1: workspaceExecutionMetricSegmentV1Schema,
  WorkspaceExecutionMetricsWorkflowV1: workspaceExecutionMetricsWorkflowV1Schema,
  WorkspaceExecutionMetricsResponseV1: workspaceExecutionMetricsResponseV1Schema,
