...
const requiredDirectories = [
  ...
  'apps/api/src/modules/data-drains/application',
  'apps/api/src/modules/data-drains/interface',
  'apps/api/src/modules/data-drains/ports',
  ...
  'apps/api/src/modules/permission-groups/application',
  'apps/api/src/modules/permission-groups/interface',
  'apps/api/src/modules/permission-groups/ports',
  ...
  'apps/api/src/modules/workspace-forking/application',
  'apps/api/src/modules/workspace-forking/interface',
  'apps/api/src/modules/workspace-forking/ports',
...
const requiredFiles = [
  ...
  'apps/api/src/config/forking-runtime.ts',
  ...
  'apps/api/src/infrastructure/postgres/repositories/drizzle-organization-invitation-housekeeping.ts',
  'apps/api/src/infrastructure/postgres/repositories/drizzle-organization-roster-read-repository.ts',
  'apps/api/src/infrastructure/postgres/repositories/drizzle-organization-workspace-read-repository.ts',
  'apps/api/src/infrastructure/postgres/repositories/drizzle-user-permission-group-read-repository.ts',
  ...
  'apps/api/tsconfig.workspace-background-work.json',
  ...
  'apps/api/src/modules/data-drains/index.ts',
  'apps/api/src/modules/data-drains/application/list-data-drain-runs.ts',
  'apps/api/src/modules/data-drains/interface/create-list-data-drain-runs-handler.ts',
  'apps/api/src/modules/data-drains/ports/data-drain-run-read-repository.ts',
  'apps/api/src/modules/data-drains/ports/data-drain-entitlement-reader.ts',
  'scripts/architecture/import-boundaries/check-data-drains-module-boundary.ts',
  ...
  'apps/api/src/modules/organizations/application/list-organization-roster.ts',
  'apps/api/src/modules/organizations/application/list-organization-workspaces.ts',
  'apps/api/src/modules/organizations/interface/create-list-organization-roster-handler.ts',
  'apps/api/src/modules/organizations/interface/create-list-organization-workspaces-handler.ts',
  'apps/api/src/modules/permission-groups/application/get-user-permission-group.ts',
  'apps/api/src/modules/permission-groups/interface/create-get-user-permission-group-handler.ts',
  'apps/api/src/modules/workspaces/index.ts',
  'apps/api/src/modules/workspaces/application/get-workspace-execution-metrics.ts',
  'apps/api/src/modules/workspaces/interface/create-get-workspace-execution-metrics-handler.ts',
  'apps/api/src/modules/workspaces/ports/workspace-execution-metrics-read-repository.ts',
  'apps/api/src/modules/workspaces/application/get-workspace-host-context.ts',
  'apps/api/src/modules/workspaces/interface/create-get-workspace-host-context-handler.ts',
  'apps/api/src/modules/workspaces/ports/workspace-host-context-read-repository.ts',
  'scripts/architecture/import-boundaries/check-workspaces-module-boundary.ts',
  'apps/api/src/modules/workspace-forking/index.ts',
  'apps/api/src/modules/workspace-forking/application/evaluate-forking-access.ts',
  'apps/api/src/modules/workspace-forking/application/get-fork-availability.ts',
  'apps/api/src/modules/workspace-forking/application/get-fork-lineage.ts',
  'apps/api/src/modules/workspace-forking/application/get-fork-resources.ts',
  'apps/api/src/modules/workspace-forking/application/list-workspace-background-work.ts',
  'apps/api/src/modules/workspace-forking/interface/create-get-fork-availability-handler.ts',
  'apps/api/src/modules/workspace-forking/interface/create-get-fork-lineage-handler.ts',
  'apps/api/src/modules/workspace-forking/interface/create-get-fork-resources-handler.ts',
  'apps/api/src/modules/workspace-forking/interface/create-list-workspace-background-work-handler.ts',
  'apps/api/src/modules/workspace-forking/ports/fork-entitlement-reader.ts',
  'apps/api/src/modules/workspace-forking/ports/fork-rollout-reader.ts',
  'apps/api/src/modules/workspace-forking/ports/workspace-background-work-reader.ts',
  'apps/api/src/modules/workspace-forking/ports/workspace-fork-current-access-reader.ts',
  'apps/api/src/modules/workspace-forking/ports/workspace-fork-context-reader.ts',
  'apps/api/src/modules/workspace-forking/ports/workspace-fork-lineage-reader.ts',
  'apps/api/src/modules/workspace-forking/ports/workspace-fork-resource-catalog-reader.ts',
  'scripts/architecture/import-boundaries/check-workspace-forking-module-boundary.ts',
  'scripts/architecture/build-isolation/check-workspace-background-work-client.ts',
  ...
  'packages/api-contracts/src/permission-groups.ts',
  'packages/db/migrations/0275_polaris_external_identity_read_model.sql',
  'extensions/biz/identity/src/personal-profile.ts',
  'extensions/infra/appconfig/package.json',
  'extensions/infra/appconfig/src/index.ts',
